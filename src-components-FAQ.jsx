  ...
  return (
    ...
    >
      <button
        ...
        className="w-full py-6 px-6 flex justify-between items-center hover:bg-gray-50 transition"
      >
        <span className="text-lg font-semibold text-gray-800 text-left">{item.q}</span>
        <motion.div animate={{ rotate: isOpen ? 180 : 0 }}>
          <FiChevronDown className="text-brand-red" size={20} />
        </motion.div>
      </button>
    ...
    <section id="faq" className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
          ...
          viewport={{ once: true }}
        >
          <h2 className="font-serif text-5xl font-bold text-brand-red mb-4">Frequently Asked Questions</h2>
        </motion.div>
